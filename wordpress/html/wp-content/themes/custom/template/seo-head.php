...
//OGP用画像
if (empty($ogp_img)) {
    $ogp_img = get_template_directory_uri() . '/include/no.jpeg'; //サイト全てに共通の画像へのパス
}
...
<!-- アイコン -->
<link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/include/favicon.ico">
<link rel="apple-touch-icon" href="<?php echo get_template_directory_uri(); ?>/include/ios.png">
<link rel="icon" type="image/png" size="256x256" href="<?php echo get_template_directory_uri(); ?>/include/android.png">
